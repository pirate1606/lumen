  ...
  return (
    <section id="demo" className="py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl sm:text-4xl font-bold text-center">Live Demo / Prototype</h2>
        <p className="mt-2 text-center text-muted-foreground">Interactive cards: CT viewer, Lab upload, Chatbot.</p>
        ...
        <div className="mt-10 grid lg:grid-cols-3 gap-6">
          ...
          <div className="card p-6">
            ...
            <div className="mt-3 h-36 rounded-xl bg-secondary p-3 text-sm overflow-auto">
              <div className="mb-2 rounded-lg bg-white p-2 shadow-sm">Hello! Ask a health question.</div>
            </div>
            <form className="mt-3 flex gap-2" onSubmit={(e)=>e.preventDefault()}>
              <input value={msg} onChange={(e)=>setMsg(e.target.value)} placeholder="Type here…" className="flex-1 rounded-lg border bg-background px-3 py-2 outline-none focus:ring-2 focus:ring-cta" />
