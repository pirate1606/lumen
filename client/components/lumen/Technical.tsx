...
function TeamCard({
  ...
  return (
    <div className="relative w-full max-w-[320px] h-[384px] flex flex-col items-center rounded-[20px] bg-white shadow-lg border border-gray-100">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20">
          ...
          <div className="flex justify-center w-full overflow-x-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-12 max-w-7xl px-6 justify-items-center">
              <TeamCard
                name="Sanchit"
